//
//  InsideChat_ReceiverAction_TableViewCell.swift
//  JobIn24
//
...
class InsideChat_ReceiverAction_TableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        if #available(iOS 11.0, *) {
            self.receiverMessage.layer.maskedCorners = [.layerMinXMinYCorner, .layerMaxXMinYCorner]
        } else {
    ...
    override func setHighlighted(_ highlighted: Bool, animated: Bool) {
        let receiverMessageBG = receiverMessage.backgroundColor
        ...
        receiverMessage.backgroundColor = receiverMessageBG
