...
class OtherUserProfileViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
//            print(self.countValue)
    ...
    override func viewDidLoad() {
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(userProfileImageClicked))
        self.profileimage.addGestureRecognizer(tapGestureRecognizer)
        self.profileimage.isUserInteractionEnabled = true
        
        let coverimgtapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(userCoverImageClicked))
    ...
    @IBAction func ChatPressed(_ sender: UIButton) {
        ...
        if(currentUser != nil){
            ...
            if currentUser!.isAnonymous {
                print("[Get OtherUser Anonymouse User")
        ...
        ref.child("UserReview").child(uid).observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            if (self.reviewcount5 != nil && self.reviewcount4 != nil && self.reviewcount3 != nil && self.reviewcount2 != nil && self.reviewcount1 != nil ){
                ...
                if self.totalreviewcount! > 0.0 {
                    ...
                    self.reviewLabel.text = "0 Reviews"
    ...
    func loadPictureName(uid:String) {
        ...
        ref.child("UserAccount").child(uid).observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            if let getData = snapshot.value as? [String:Any]{
                ...
                useraccountCoverImage = userImage!
        ...
        ref.child("UserInfo").observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            if(!snapshot.childSnapshot(forPath: uid).exists()){
                ...
                self.coverImage.downloadprofileImage(from: useraccountCoverImage)
                ...
                self.usercoverImage = useraccountCoverImage
                return
            }
